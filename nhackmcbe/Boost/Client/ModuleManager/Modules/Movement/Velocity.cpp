...
Velocity::Velocity() : Module("Velocity", "Don't ever take knockback again.", Category::MOVEMENT) {
	addSlider<float>("XZ Modifier", "Changes x & z velocity.", ValueType::FLOAT_T, &xzModifier, 0.f, 32.f);
	addSlider<float>("Y Modifier", "Changes y velocity.", ValueType::FLOAT_T, &yModifier, 0.f, 32.f);
}
