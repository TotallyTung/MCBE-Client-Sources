...
Velocity::Velocity() : Module("Velocity", "Don't ever take knockback again.", Category::MOVEMENT) {
	slider<float>("XZ Modifier", "Changes x & z velocity.", ValueType::FLOAT_T, &xzModifier, 0.f, 1.f);
	slider<float>("Y Modifier", "Changes y velocity.", ValueType::FLOAT_T, &yModifier, 0.f, 1.f);
}
