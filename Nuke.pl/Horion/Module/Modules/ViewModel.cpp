...
ViewModel::ViewModel() : IModule(0, Category::VISUAL, "Custom item view model.") {
	...
	registerFloatSetting("TranslateX", &xTrans, 0.f, -20.f, 20.f);
	registerFloatSetting("TranslateY", &yTrans, 0.f, -20.f, 20.f);
	registerFloatSetting("TranslateZ", &zTrans, 0.f, -20.f, 20.f);

	registerFloatSetting("ScaleX", &xMod, 1.f, -20.f, 20.f);
	registerFloatSetting("ScaleY", &yMod, 1.f, -20.f, 20.f);
	registerFloatSetting("ScaleZ", &zMod, 1.f, -20.f, 20.f);
}
