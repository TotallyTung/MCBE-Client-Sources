...
public:
	void *ptr = nullptr;
	EnumEntry(const std::string _name, const unsigned char value, const char* tooltip2 = "");
	EnumEntry(const char *_name, const unsigned char value, const char* tooltip2 = "");
	std::string GetName();
...
public:
	...
	// SettingEnum();
	SettingEnum &addEntry(EnumEntry entr, const char* tooltip2 = "");
	SettingEnum &addEntry(const char *name, int value, const char* tooltip2 = "");
...
protected:
	...
	void registerFloatSetting(std::string name, float *floatPtr, float defaultValue, float minValue, float maxValue, float step = 0.01, const char *tooltip2 = "");
	SettingEntry *registerIntSetting(std::string name, int *intpTr, int defaultValue, int minValue, int maxValue, const char *tooltip2 = "");
	void registerEnumSetting(std::string name, SettingEnum *intPtr, int defaultValue, const char *tooltip2 = "");
	SettingEntry *registerEnumSettingGroup(std::string name, SettingEnum *enumPtr, int defaultValue, const char *tooltip2 = "");
	void registerBoolSetting(std::string name, bool *boolPtr, bool defaultValue, const char *tooltip2 = "");
...
public:
	...
	virtual const char *getModuleName(); // will be remove later
