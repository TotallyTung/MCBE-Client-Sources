...
public:
	...
	static void drawFilledBox(vec3_t pos, bool isAnim = false, float t = 0.5f);
	static void drawFilledBox2D(vec3_t pos, float height = 0.f);
	static void drawBoxFilled(const vec3_t& lower, const vec3_t& upper, float scale, bool onUi);
	...
	static void drawwtf(vec3_t lower, float opacity);
	static void draw4Faces(vec3_t lower, vec3_t upper);
	static void drawBox(const vec3_t& lower, const vec3_t& upper, float lineWidth, bool fill = false, int mode = 1, bool enableLerp = false, float lerpDuration = 1.f, float elapsedLerpTime = 0.f);
	...
	static void DrawBarItem(C_ItemStack* stack, vec2_t ItemPos, float scale);
	static void drawItem(C_ItemStack *item, vec2_t ItemPos, float opacity, float scale, bool isEnchanted);
	static void drawItemInWorld(C_ItemStack* item, const vec3_t& location, float opacity, float scale, bool isEnchanted);
