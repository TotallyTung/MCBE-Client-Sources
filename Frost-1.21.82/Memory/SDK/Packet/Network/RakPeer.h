...
namespace RakNet {
	class RakPeer {
	private:
		virtual void Destructor() {}; // RakPeer's Destructor.
	...
	public:
		...
		virtual uint32_t SendLoopback(char const*, int, __int64, __int64, char, __int64, bool, uint32_t);
		virtual void Send(char const*, int);
		...
		virtual __int64 getMaximumNumberOfPeers(void);
