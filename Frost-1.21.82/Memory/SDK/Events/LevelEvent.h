...
enum class LevelEvent : short {
    ...
    StartBlockBreaking                    = 0xE10,
    StopBlockBreaking                     = 0xE11,
    UpdateBlockCracking                   = 0xE12,
    ParticlesCrackBlockDown               = 0xE13,
    ParticlesCrackBlockUp                 = 0xE14,
    ParticlesCrackBlockNorth              = 0xE15,
    ParticlesCrackBlockSouth              = 0XE16,
    ParticlesCrackBlockWest               = 0xE17,
    ParticlesCrackBlockEast               = 0xE18,
    ParticlesShootWhiteSmoke              = 0xE19,
    ParticlesBreezeWindExplosion          = 0xE1A,
    ParticlesTrialSpawnerDetection        = 0xE1B,
    ParticlesTrialSpawnerSpawning         = 0xE1C,
    ParticlesTrialSpawnerEjecting         = 0xE1D,
    ParticlesWindExplosion                = 0xE1E,
    ParticlesTrialSpawnerDetectionCharged = 0xE1F,
    ParticlesTrialSpawnerBecomeCharged    = 0xE20,
    AllPlayersSleeping                    = 0xE21,
    Deprecated                            = 0xE22,
    SleepingPlayers                       = 0x2649,
    JumpPrevented                         = 0x2652,
    AnimationVaultActivate                = 0x2653,
    AnimationVaultDeactivate              = 0x2654,
    AnimationVaultEjectItem               = 0x2655,
    AnimationSpawnCobweb                  = 0x2656,
    ParticleSmashAttackGroundDust         = 0x2657,
