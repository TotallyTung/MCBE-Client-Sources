...
void InitializeClient() {
    ...
    setWindowTitle(L"Floence");
    FileUtils::InitializeClientFolders(); // This is used to initialize clients folders.
    FileUtils::debugOutput("[Floence] injected");
    FileUtils::debugOutput("[Floence] initializing");
    InitializeMods(); // This is used to initialize modules & sort categories.
    FileUtils::debugOutput("[Floence] initialized modules (1/3)");
    CommandMgr.InitializeCommands(); // This is used to initialize commands.
    FileUtils::debugOutput("[Floence] Initialized commands (2/3)");
    InitializeHooks(); // This zephyr used to initialize hooks to the proccess.
    FileUtils::debugOutput("[Floence] Initialized hooks (3/3)");
    Global::Notification.addNotification("Floence", "you can bind to.bind command.", 3);
    Global::Notification.addNotification("Floence", "Default clickgui is insert.", 3);
    Global::Notification.addNotification("Floence", "Injected.", 3);
