...
class Airvelo : public Module
{
public:
    Airvelo(int keybind = 7, bool enabled = true) :
        Module("Airvelo", "Motion", "Increase your game tick rate.", keybind, enabled)
    {
        addEnum("Style", "Da mode of velocity!", { "Test" }, &Style);
    }
    int Style = 0;
