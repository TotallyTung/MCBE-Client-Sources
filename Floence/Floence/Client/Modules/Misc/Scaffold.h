...
public:
        ...
        Module("Scaffold", "Misc", "Builds blocks for you.", keybind, enabled)
    {
        ...
        addSlider("PlacesPerTick", "how many blocks it can place in tick", &placesPerTick, 0.1, 10);
...
public:
    ...
    void renderAeolusBlockAmountDisplay() {
        if (foundBlock) {
            ...
            float inScale = inEase.easeOutElastic();
            ...
            //ImRenderUtil::fillShadowRectangle(rectPos, UIColor(255, 255, 255), 0.4f, 60, 0);
