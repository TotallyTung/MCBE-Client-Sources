...
public:
    ...
    void drawClientNametag(Actor* entity)
    {
        ...
        std::string connectedClient = Utils::combine("" "" "");
        //std::string connectedClient = Utils::combine("[" "Ambrosial" "]")
        ...
        //if (Authentication::getUsername() == "Glave") {
        //    clientUser = "glave";
        //}


        //std::string connectedUser = Utils::combine(" (", clientUser, ")");
        std::string connectedUser = Utils::combine("");
