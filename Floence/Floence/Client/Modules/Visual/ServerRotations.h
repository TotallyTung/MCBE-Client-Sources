...
public:
        ...
        Module("ServerRotations", "Visual", "Renders rotations using the packets sent", keybind, enabled)
    {
        ...
        addBool("gay rotation", "gay to gay ahh gyatt?", &gay);
    }
    ...
    void onEvent(IntersectsTickEvent* event) override {
        ...
        if (gay) {
            Global::HeadYawSpeed = 999999999999999999;
            Global::BodyYawSpeed = 999999999999999999;
            Global::PitchSpeed = 999999999999999999;
            gay = false;
        }
    }
