...
#include "Combat/AutoBow.h"

// Misc
#include "Misc/Airswim.h" //(actually,its javascaf :joy:)
...
#include "Visual/DamageEffects.h"
...
void InitializeModules() {
	...
	modules.push_back(new Aura(Keys::NONE, false));
	modules.push_back(new Teams(Keys::NONE, false));
	modules.push_back(new AutoBow(Keys::NONE, false));
	...
	modules.push_back(new Javascaf(Keys::NONE, false));
	modules.push_back(new KBTests(Keys::NONE, false));
	...
	modules.push_back(new ProtocoolSpoof(Keys::NONE, false));
	...
	modules.push_back(new DeviceSpoofer(Keys::NONE, false));
	
	// Movement
	modules.push_back(new AirJump(Keys::NONE, false));
	modules.push_back(new Airvelo(Keys::NONE, false));
...
//	modules.push_back(new Franky(Keys::NONE, false));
	...
	modules.push_back(new DamageEffects(Keys::NONE, false));
	...
	modules.push_back(new SmallItems(Keys::NONE, false));
