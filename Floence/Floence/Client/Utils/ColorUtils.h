...
public:
	...
	inline static UIColor getClientColor(float seconds, float saturation, float brightness, int index) {
		...
		case 8: // White
			...
			break;
		case 9: //Red and Black
			colorMap =
			{
				{0.0f,  UIColor(33, 33, 33)},
				{0.5f,  UIColor(255, 0, 0)},
				{1.0f,  UIColor(33, 33, 33)},
			};
			return getCustomColors(seconds, index * 2, colorMap);
			break;
		case 10: // test
			...
			{
				/*{0.0f, UIColor(255, 255, 255)},
				{0.5f, UIColor(143, 158, 255)},
				{1.0f, UIColor(255, 255, 255)}*/
		        {0.0f,  UIColor(255, 0, 0)},
				{0.5f,  UIColor(255, 0, 255)},
		...
		case 11: // test2
			colorMap =
			{
				{0.0f,  UIColor(58, 5, 194)},
				{0.5f,  UIColor(125, 0, 161)},
				{1.0f,  UIColor(58, 5, 194)},
			};
			return getCustomColors(seconds, index * 2, colorMap);
			break;
		case 12: // Light Blue
			colorMap =
			{
				{0.0f,  UIColor(150, 200, 255)},
				{0.5f,  UIColor(255, 255, 255)},
				{1.0f,  UIColor(150, 200, 255)},
			};
			return getCustomColors(seconds, index * 2, colorMap);
			break;
		case 13: // vanilla gays
			colorMap =
			{
				{0.0f,  UIColor(85, 155, 205)},
				{0.5f,  UIColor(155, 25, 185)},
				{1.0f,  UIColor(85, 155, 205)}
			};
			return getCustomColors(seconds, index * 2, colorMap);
			break;
		}
