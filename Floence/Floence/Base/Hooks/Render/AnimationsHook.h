...
public:
	...
	bool Initialize() override // Now override the Initialize function so we can actually hook our stuff
	{
		...
		void* ViewBobbingAddr = Memory::findSig(xorstr_("48 89 5C 24 ? 57 48 81 EC ? ? ? ? 0F 29 B4 24 ? ? ? ? 48 81 C1"));

		// Mob::getCurrentSwingDuration(void)
		void* getCurrentSwingDurationAddr = Memory::findSig(xorstr_("48 89 5C 24 ? 48 89 6C 24 ? 56 57 41 56 48 83 EC ? 8B 41 ? 48 8D 54 24 ? 48 8B 35"));
