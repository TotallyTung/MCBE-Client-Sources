...
public:
    bool Initialize() override // Now override the Initialize function so we can actually hook our stuff
    {
        ...
        void* containerTickAddr = Memory::findSig(xorstr_("E8 ? ? ? ? 48 8B 8B ? ? ? ? 48 8D 93 ? ? ? ? 41 B8"));
        containerTickAddr = (void*)((uintptr_t)containerTickAddr + 5 + *reinterpret_cast<int*>((uintptr_t)containerTickAddr + 1));
