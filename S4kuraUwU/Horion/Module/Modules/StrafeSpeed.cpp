...
StrafeSpeed::StrafeSpeed() : IModule(0x0, Category::MOVEMENT, "Best Speed") {
	registerBoolSetting("Sprinting", &this->sprint, this->sprint);

	registerFloatSetting("GroundSpeed", &this->nspeed, this->nspeed, 0.3, 1);
	registerFloatSetting("AirSpeed", &this->jspeed, this->jspeed, 0.17, 3);
	...
	registerFloatSetting("AirSneakedSpeed", &this->jsspeed, this->jsspeed, 0.13, 3);
	registerFloatSetting("SneakedSpeed", &this->sspeed, this->sspeed, 0.1, 3);
}
