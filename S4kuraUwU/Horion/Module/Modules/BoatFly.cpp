...
BoatFly::BoatFly() : IModule(0, Category::MOVEMENT, "Fly, for boats (Use arrow Keys for Virtical Movement!)") {
	this->registerFloatSetting("Fly Speed", &this->boatflyspeed, this->boatflyspeed, 1.f, 50.f);
}
