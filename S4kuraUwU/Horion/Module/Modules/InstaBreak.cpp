...
InstaBreak::InstaBreak() : IModule(0, Category::WORLD, "Geyser Packet Mine - idk if it works on other servers") {
...
bool isPointBlockGood() {
	...
	int pmr = moduleMgr->getModule<InstaBreak>()->mineRange;
...
int InstaBreak::ticksToMine(vec3_ti toMine) {
...
void InstaBreak::onPreRender(C_MinecraftUIRenderContext* renderCtx) {
