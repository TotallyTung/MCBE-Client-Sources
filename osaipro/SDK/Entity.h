...
public:
	...
	ItemStack* getOffhandItem() {
		return (ItemStack*)(*(__int64(__fastcall**)(__int64, __int64))(**((__int64**)this + 208) + 40i64))(
			*((__int64*)this + 208),
			1i64);
	};														 // 444
																					 // 357
	...
	int Health = 20;
	bool totem = true;
	struct DataItem* __fastcall _find(__int64* _this, unsigned __int16 a2) {
		if (a2 < (unsigned __int16)((__int64)(*((__int64*)_this + 1) - *(__int64*)_this) >> 3))
			return *(struct DataItem**)(*(__int64*)_this + 8i64 * a2);
		else
			return 0i64;
	}

	char __fastcall getStatusFlag(__int64 a1, int a2) {
		unsigned __int16 v3;  // ax
		struct DataItem* v4;  // rax

		v3 = 92;
		if (a2 < 64)
			v3 = 0;
		v4 = _find((__int64*)(a1 + 376), v3);
		if (v4) {
			v4 = (struct DataItem*)*((__int64*)v4 + 2);
			unsigned __int64 temp = (unsigned __int64)v4;
			temp &= 0xFFFFFFFFFFFFFF00;                                            // LOBYTEを0にする
			temp |= _bittest64((const __int64*)&v4, (unsigned __int8)(a2 % 64));  // LOBYTEを更新する
			v4 = (struct DataItem*)temp;                                          // v4を更新
		}
		return (char)v4;
		}
...
public:
	...
	__int64 *getUniqueId() {
		...
		*/
		...
		if (*((__int64 *)this + 32) == -1i64) {
			v2 = *((__int64 *)this + 109);
			if (v2)
				*v1 = *(__int64 *)(*(__int64(__fastcall **)(__int64, char *))(*(__int64 *)v2 + 1968i64))(v2, &v4);
		}
		return (__int64 *)v1;
	}
	...
	__int64 getAllEffect() {
		return *reinterpret_cast<__int64*>(reinterpret_cast<__int64>(this) + 0x520);
	}
	...
	bool isSneaking() {
		struct DataItem *v1;  // rax

		v1 = _find((__int64 *)((char *)this + 376), 0);
		if (v1) {
			unsigned __int64 temp = (unsigned __int64)v1;
			temp &= 0xFFFFFFFFFFFFFF00;             // LOBYTEを0にする
			temp |= (*((BYTE *)v1 + 16) & 2) != 0;  // LOBYTEを更新	
			v1 = (struct DataItem *)temp;           // v1を更新
		}
		return (char)v1;
	}

	bool isSprinting() {
		return (bool)getStatusFlag((__int64)this, 3i64);
	}
	bool isGliding() {
		return (bool)getStatusFlag((__int64)this, 32i64);
	}
	bool totemUsed() {
		uintptr_t value = FindSignature("48 89 5C 24 08 48 89 6C 24 10 48 89 74 24 18 48 89 7C 24 20 41 56 48 81 EC B0 00 00 00 48 8B DA");
		return (bool)value;
	}
	float getHealth() {
...
public:
	...
	float getDestroyProgress(Block *block) {
		using getDestroyProgressFunc = float(__fastcall *)(Player *, Block *);
		static getDestroyProgressFunc Func = (getDestroyProgressFunc)(Utils::getBase() + 0x1EEF9D0);
...
public:
	...
	void switchHotbar(int slot) {
		if (slot != -1) this->getSupplies()->selectedHotbarSlot = slot;
	}
