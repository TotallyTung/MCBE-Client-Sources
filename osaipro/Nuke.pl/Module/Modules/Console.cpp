...
ConsoleMod::ConsoleMod() : IModule(VK_INSERT, Category::CLIENT, "The clickgui - toggle everything just by clicking on it!") {
}
ConsoleMod::~ConsoleMod() {
}
const char* ConsoleMod::getModuleName() {
    return ("MovableWatermark");
}
...
void ConsoleMod::onImGuiRender(ImDrawList* d) {
}

#include <Windows.h>
void ConsoleMod::onPostRender(MinecraftUIRenderContext* renderCtx) {
    // --- Draggable Watermark --- //
    ...
    std::string placeholderText = "osai pro";
...
void ConsoleMod::onPreRender(MinecraftUIRenderContext* renderCtx) {
}
