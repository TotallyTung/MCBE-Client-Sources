...
HoleEsp::HoleEsp() : IModule(0x0, Category::VISUAL, "Shows nearby holes")
{
	...
	registerFloatSetting("Step", &Step, 0.01f, 0.f, 0.1f);;
	...
	if (!(Game.getLocalPlayer() == nullptr || !GameData::canUseMoveKeys())) {
		if (Game.isInGame()) {
			if (!moduleMgr->getModule<ClickGuiMod>()->isEnabled()) {
				...
				Vec3 MyPos = Game.getLocalPlayer()->getPos()->floor();
				Vec3 MyPos2 = Vec3(MyPos.x, MyPos.y + 2, MyPos.z);
				for (int x = (int)pos->x - range; x < pos->x + range; x++)
				{
					for (int z = (int)pos->z - range; z < pos->z + range; z++)
					{
						for (int y = (int)pos->y - range; y < pos->y + range; y++)
						{
							...
							Vec3 blockPosTrapped = Vec3(x, y + 2, z - 1);
							...
							Block* blockTrapped = Game.getLocalPlayer()->region->getBlock(blockPosTrapped);
							...
							if (block != nullptr && block2 != nullptr && block3 != nullptr && block4 != nullptr && blockTrapped != nullptr) {
								...
								int blockIDTrapped = blockTrapped->toLegacy()->blockId;
								...
								bool show;
								if (air == MyPos)  show = false;
								else show = true;
								if (bedrock)
								{
									if ((blockId2 == 7 && blockId3 == 7 && blockId4 == 7 && blockId5 == 7 && blockId6 == 7 && blockId == 0) && (aircheck == 0) && show)
									{
										...
										{
											DrawUtils::drawFilledBox2D(Vec3(blockPos.x + 0.5f, blockPos.y - 0.5f, blockPos.z + 0.5f), height);
										}
										if (outline)
										{
											if (!bsync)
											...
											DrawUtils::drawBox(blockPos, Vec3(blockPos).add(1.f, height, 1.f), (float)LineSize, false);
										}
									}
								}
								if (obsidian)
								{
									if ((blockId2 == 49 || blockId2 == 7) && (blockId3 == 49 || blockId3 == 7) && (blockId4 == 49 || blockId4 == 7) && (blockId5 == 49 || blockId5 == 7) && (blockId6 == 49 || blockId6 == 7) && (blockId == 0) && (aircheck == 0) && !((blockId2 == 7 && blockId3 == 7 && blockId4 == 7 && blockId5 == 7 && blockId6 == 7 && blockId == 0) && (aircheck == 0)) && show)
									{
										// Vec3 block = blockPos.add(0.5, -0.5, 0.5);
										// float rentimer = 1;
										// float zero = rentimer / 2;
								...
								if (mixed)
								{
									if ((blockId2 == 7 || blockId3 == 7 || blockId5 == 7 || blockId6 == 7) && (blockId == 0) && (blockId2 == 49 || blockId3 == 49 || blockId5 == 49 || blockId6 == 49) && show)
									{
